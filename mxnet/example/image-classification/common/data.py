...
def get_rec_iter(args, kv=None):
    ...
    train = mx.io.ImageRecordIter(
        shuffle=True,
        path_imgrec="/home/constr/workshop/projects/FlaskDriverMXNet2SeetaNet/test/try_train2.rec",
        rand_crop=True,
        rand_mirror=True,
        data_shape=(3,28,22),
        batch_size=args.batch_size,
    ...
    val = mx.io.ImageRecordIter(
        path_imgrec="/home/constr/workshop/projects/FlaskDriverMXNet2SeetaNet/test/try_val2.rec",
        rand_crop=False,
        rand_mirror=False,
        data_shape=(3,28,22),
        batch_size=args.batch_size,
